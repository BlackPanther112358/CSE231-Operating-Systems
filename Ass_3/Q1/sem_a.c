...
int main(){
    ...
    pthread_create(&philosophers[0].pid, NULL, philosopher, &philosophers[0]);
    pthread_create(&philosophers[1].pid, NULL, philosopher, &philosophers[1]);
    pthread_create(&philosophers[2].pid, NULL, philosopher, &philosophers[2]);
    pthread_create(&philosophers[3].pid, NULL, philosopher, &philosophers[3]);
    pthread_create(&philosophers[4].pid, NULL, philosopher, &philosophers[4]);
